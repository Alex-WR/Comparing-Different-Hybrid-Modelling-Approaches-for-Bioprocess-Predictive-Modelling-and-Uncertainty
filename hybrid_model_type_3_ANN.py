...
data = torch.load(MAIN.cache + '\_parameterised_data_3'); n_vars = len(I)
...
class HybridModel(ANN_trainer):
    ...
    def multi_step_ahead(self, data, sample_size=3000, smooth_edge_ratio=50):
