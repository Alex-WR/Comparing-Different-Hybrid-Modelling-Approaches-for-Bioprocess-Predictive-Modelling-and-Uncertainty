...
for i in i_step:
    ...
    setattr(m, 'y_sx' + str(i), Var(m.e, bounds=(1, 20)))
...
def _sdot (m, i, e): 
      if i == 0:
         ...
         return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m0[e], m.k_c, m.y_sx0[e])
      elif i>12 and i<=24:
         return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m1[e], m.k_c, m.y_sx1[e])
      elif i>24 and i<=36:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m2[e], m.k_c, m.y_sx2[e])
      elif i>36 and i<=48:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m3[e], m.k_c, m.y_sx3[e])
      elif i>48 and i<=60:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m4[e], m.k_c, m.y_sx4[e])
      elif i>60 and i<=72:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m5[e], m.k_c, m.y_sx5[e])
      elif i>72 and i<=84:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m6[e], m.k_c, m.y_sx6[e])
      elif i>84 and i<=96:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m7[e], m.k_c, m.y_sx7[e])
      elif i>96 and i<=108:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m8[e], m.k_c, m.y_sx8[e])
      elif i>108 and i<=120:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m9[e], m.k_c, m.y_sx9[e])
      elif i>120 and i<=132:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m10[e], m.k_c, m.y_sx10[e])
      elif i>132 and i<=144:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m11[e], m.k_c, m.y_sx11[e])
      elif i>144 and i<=156:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m12[e], m.k_c, m.y_sx12[e])  
      elif i>156 and i<=168:
          return m.dSdt[i, e] == MAIN.HY_dSdt(m.X[i, e], m.S[i, e], m.P[i, e], m.mu_m13[e], m.k_c, m.y_sx13[e])
...
weights = [0, MAIN.w_Y, 0] #1e-6
varbs   = ['mu_m', 'y_sx', 'beta']
...
discretizer.apply_to(instance, nfe=10, ncp=6, scheme='LAGRANGE-RADAU')
# =============================================================================
...
parameterised_data = {e: np.column_stack([insilico_data[e],
                         ...
                         np.append(np.array([value(getattr(instance, 'y_sx' + str(i))[e]) for i in i_step]), np.nan),
...
for e in insilico_data.keys():
    ...
    plt.plot(t, Y[:, 0], 'b--', label='Re-Integrated', ms=ms, lw=lw)
    plt.xlabel("Time(h)")
    ...
    plt.plot(t, Y[:, 1], 'b--', label='Re-Integrated', ms=ms, lw=lw)
    plt.xlabel("Time(h)")
    ...
    #lt.plot(t, Y[:, 2], 'b--', label='Re-Integrated', ms=ms, lw=lw)
    plt.xlabel("Time(h)")
...
# %% <Export Cache>
torch.save(parameterised_data, MAIN.cache + '\_parameterised_data_3')  
